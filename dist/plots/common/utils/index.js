 ...
 */
export function getChartFontStyles() {
 ...
 * Uses CSS-defined font styles by default (from .chart text class).
 */
export function measureMaxTextWidth(texts, fontSize, fontFamily) {
    var _a;
    if (texts.length === 0)
        return 0;
    const measureSvg = getMeasurementSvg();
 ...
 */
export function mergeWithDefaults(defaults, props) {
 ...
 */
export function getDomainKind(domain) {
