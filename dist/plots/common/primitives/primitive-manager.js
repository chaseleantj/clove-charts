...
import { PointPrimitive, LinePrimitive, RectanglePrimitive, TextPrimitive, PathPrimitive, AreaPrimitive, ContourPrimitive, ImagePrimitive, BatchPointsPrimitive, BatchLinesPrimitive, BatchRectanglesPrimitive, BatchTextPrimitive, PrimitiveInfoMap, } from './primitives';
...
class PrimitiveManager {
    constructor(BasePlot) {
        ...
        this.defaultLayer = this.createLayer(DEFAULT_PRIMITIVE_CONFIG.layerName);
    }
    ...
    createSvgElement(primitiveClass, layer, options, primitiveInfo) {
        ...
        const className = isBatch
            ...
            : options.className;
        const elementType = primitiveClass === TextPrimitive && options.latex
            ? 'foreignObject'
