...
export interface MutablePrimitiveConfig<TFill = string, TStroke = string, TStrokeWidth = number, TOpacity = number> {
    fill?: TFill;
    stroke?: TStroke;
...
export type PrimitiveConfig<TFill = string, TStroke = string, TStrokeWidth = number, TOpacity = number> = ImmutablePrimitiveConfig & MutablePrimitiveConfig<TFill, TStroke, TStrokeWidth, TOpacity>;
export type DataDrivenValue<T> = T | ((d: Record<string, any>) => T);
export type BatchPrimitiveConfig = PrimitiveConfig<DataDrivenValue<string>, DataDrivenValue<string>, DataDrivenValue<number>, DataDrivenValue<number>>;
