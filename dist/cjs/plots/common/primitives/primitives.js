...
exports.PrimitiveInfoMap = exports.BatchTextPrimitive = exports.BatchRectanglesPrimitive = exports.BatchLinesPrimitive = exports.BatchPointsPrimitive = exports.BatchPrimitive = exports.ImagePrimitive = exports.ContourPrimitive = exports.AreaPrimitive = exports.PathPrimitive = exports.TextPrimitive = exports.RectanglePrimitive = exports.LinePrimitive = exports.PointPrimitive = exports.Primitive = void 0;
const d3 = __importStar(require("d3"));
const scale_manager_1 = require("../scale-manager");
...
class Primitive {
    ...
    convertX(x) {
        ...
        return (0, scale_manager_1.isContinuousScale)(scale) ? scale(x) : x;
    }
    convertY(y) {
        if (this.options.coordinateSystem === 'pixel') {
            return y;
        ...
        return (0, scale_manager_1.isContinuousScale)(scale) ? scale(y) : y;
    }
...
class TextPrimitive extends Primitive {
    ...
    renderMath(element, x, y) {
        return (0, utils_1.renderKatex)(this.text, element, x, y, this.angle);
    }
}
exports.TextPrimitive = TextPrimitive;
class PathPrimitive extends Primitive {
    constructor(manager, element, options) {
        super(manager, element, options);
        this.dataPoints = [];
    }
...
class AreaPrimitive extends Primitive {
    constructor(manager, element, options) {
        super(manager, element, options);
        this.dataPoints = [];
    }
...
exports.AreaPrimitive = AreaPrimitive;
class ContourPrimitive extends Primitive {
    constructor(manager, element, options) {
        super(manager, element, options);
...
exports.ContourPrimitive = ContourPrimitive;
...
class BatchPrimitive extends Primitive {
    constructor(manager, element, options) {
        super(manager, element, options);
        this.dataPoints = [];
        this.elementSelection = d3.select(null);
...
exports.BatchPrimitive = BatchPrimitive;
class BatchPointsPrimitive extends BatchPrimitive {
    constructor(manager, element, options) {
        super(manager, element, options);
    }
    setCoordinateAccessors(xAccessor, yAccessor) {
...
exports.BatchPointsPrimitive = BatchPointsPrimitive;
class BatchLinesPrimitive extends BatchPrimitive {
    constructor(manager, element, options) {
        super(manager, element, options);
    }
...
exports.BatchLinesPrimitive = BatchLinesPrimitive;
class BatchRectanglesPrimitive extends BatchPrimitive {
    constructor(manager, element, options) {
        super(manager, element, options);
...
exports.BatchRectanglesPrimitive = BatchRectanglesPrimitive;
class BatchTextPrimitive extends BatchPrimitive {
    constructor(manager, element, options) {
        super(manager, element, options);
...
exports.BatchTextPrimitive = BatchTextPrimitive;
exports.PrimitiveInfoMap = new Map([
